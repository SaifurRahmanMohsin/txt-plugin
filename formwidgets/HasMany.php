<?php namespace Mohsin\Txt\FormWidgets;
...
class HasMany extends FormWidgetBase {
    ...
    private function prepareVars()
    {
        ...
        if (!isset($this->config->default['label']) && empty($this->config->partial))
            throw new Exception('A default label or custom partial must be defined for "'.$fiendName.'".');
